...
const PremiumBackground = React.memo(() => {
    return (
        <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden bg-[#000000] transform-gpu translate-z-0 backface-hidden perspective-1000">
            ...
            {/* 3. Orbital Ambient Glows - Static */}
            <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-amber-600/10 rounded-full blur-[60px] md:blur-[120px] mix-blend-screen will-change-transform transform-gpu" />
            <div className="absolute top-[20%] right-[-10%] w-[35%] h-[35%] bg-emerald-900/10 rounded-full blur-[50px] md:blur-[100px] mix-blend-screen will-change-transform transform-gpu" />
            <div className="absolute bottom-[-10%] left-[20%] w-[45%] h-[45%] bg-indigo-900/10 rounded-full blur-[70px] md:blur-[140px] mix-blend-screen will-change-transform transform-gpu" />
