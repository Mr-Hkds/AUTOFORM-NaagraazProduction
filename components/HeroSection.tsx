...
const HeroSection: React.FC<HeroSectionProps> = ({ url, setUrl, onAnalyze, onWatchDemo, loading }) => {
    return (
        <section className="flex-1 flex flex-col items-center justify-center w-full animate-fade-in-up px-4 md:px-6 relative z-10 min-h-[60vh] py-12 overflow-hidden">

            {/* Hero Content */}
            <div className="max-w-4xl mx-auto text-center space-y-8 md:space-y-10 mb-12 md:mb-16 w-full">
                ...
                {(() => {
                    ...
                    return isFirstTime ? (
                        ...
                        <div className="inline-flex items-center justify-center gap-3 px-5 py-2 rounded-full glass-panel border border-white/5 shadow-2xl backdrop-blur-md animate-fade-in-down mb-6 mx-auto">
                ...
                {/* Headline */}
                <div className="space-y-4 md:space-y-6 relative px-2">
                    <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-serif font-medium tracking-tight leading-[1.1] py-2 relative z-10">
                        <span className="block text-slate-400 opacity-80 text-sm md:text-xl font-sans font-light tracking-[0.2em] md:tracking-[0.3em] uppercase mb-2 md:mb-4 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
                    ...
                    <p className="text-slate-300 text-xs sm:text-sm md:text-base max-w-2xl mx-auto font-mono leading-relaxed tracking-tight animate-fade-in-up px-4" style={{ animationDelay: '300ms' }}>
                        Deploy thousands of authentic, scientifically-weighted responses to any Google Form.
                        <span className="block mt-4 text-slate-500 font-sans font-medium opacity-80 text-[10px] md:text-xs tracking-[0.15em] md:tracking-[0.2em] uppercase flex flex-col md:block gap-1">
                ...
                {/* Input Area */}
                <div className="max-w-2xl mx-auto w-full relative z-20 animate-scale-in px-2" style={{ animationDelay: '400ms' }}>
                    <div className="relative bg-[#0A0A0A]/80 border border-white/10 rounded-3xl md:rounded-full p-2 flex flex-col md:flex-row items-center gap-2 md:gap-4 backdrop-blur-xl transition-all duration-300 hover:border-amber-500/30 hover:shadow-[0_0_30px_rgba(245,158,11,0.1)] group overflow-hidden">
                        ...
                        {/* Input Wrapper */}
                        <div className="flex items-center w-full md:w-auto flex-1 pl-4 pr-2 py-2 md:py-0">
                            {/* Input Icon */}
                    ...
                    <div className="mt-6 flex flex-col md:flex-row items-center justify-center gap-4 animate-fade-in-up" style={{ animationDelay: '500ms' }}>
                        ...
                        <span className="text-[10px] text-slate-500 font-mono uppercase tracking-widest opacity-60">v4.0.0 Stable</span>
                    </div>

                    {/* Premium Status Bar */}
                    <div className="mt-8 relative group cursor-default animate-fade-in-up w-full" style={{ animationDelay: '500ms' }}>
                        ...
                        <div className="relative flex flex-col md:flex-row items-center justify-center p-1 rounded-2xl md:rounded-full bg-[#0A0A0A]/40 border border-white/5 backdrop-blur-md shadow-[0_4px_20px_-1px_rgba(0,0,0,0.2)] hover:border-white/10 transition-all duration-500 w-full md:w-auto mx-auto max-w-sm md:max-w-none">
                            ...
                            {/* Item 1 */}
                            <div className="w-full md:w-auto px-6 py-3 md:py-2 border-b md:border-b-0 md:border-r border-white/5 flex items-center justify-between md:justify-center gap-4 md:gap-3 group/item transition-colors hover:bg-white/[0.02] md:hover:bg-transparent rounded-t-xl md:rounded-none">
                            ...
                            {/* Item 2 */}
                            <div className="w-full md:w-auto px-6 py-3 md:py-2 border-b md:border-b-0 md:border-r border-white/5 flex items-center justify-between md:justify-center gap-4 md:gap-3 group/item transition-colors hover:bg-white/[0.02] md:hover:bg-transparent">
                                <div className="flex items-center gap-4 md:gap-3">
                                    <div className="p-1.5 rounded-full bg-white/5 group-hover/item:bg-amber-500/10 transition-colors duration-300">
                            ...
                            {/* Item 3 */}
                            <div className="w-full md:w-auto px-6 py-3 md:py-2 flex items-center justify-between md:justify-center gap-4 md:gap-3 group/item transition-colors hover:bg-white/[0.02] md:hover:bg-transparent rounded-b-xl md:rounded-none">
                                <div className="flex items-center gap-4 md:gap-3">
                                    <div className="p-1.5 rounded-full bg-white/5 group-hover/item:bg-amber-500/10 transition-colors duration-300">
